...
public interface IClimateAnalyzer {
	...
	// TASK A-2
	// for all data that matches the specified year, get the lowest
	// temperature reading
	
	public ITemperature getHighestTempByYear(String country, int year);
	// TASK A-2
	// for all data that matches the specified year, get the highest
	// temperature reading
	...
	public ArrayList<ITemperature> allCountriesTop10TempDelta(int month, int year, int year2);
	// TASK C-1
